const CACHE_NAME='onomo-shell-v24';
const SHELL=['./','./index.html','./assets/css/app.css','./assets/css/responsive.css','./assets/css/interactions.css','./assets/css/onomo-design.css','./assets/js/ui.js','./assets/js/ui-polish.js','./assets/js/dashboard-polish.js','./assets/js/app.js','./assets/js/runtime-sync.js','./assets/js/i18n.js','./assets/js/locales-data.js','./assets/js/modern-features.js','./assets/js/corrections.js','./assets/pwa/onomo-hotels.png'];
